...
public class AdapterListBasic2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<PersonDtoReq> items = new
            ArrayList<>();
    List<PersonAction> personActionList = new ArrayList<>();
    ...
    public AdapterListBasic2(Context context, List<PersonDtoReq> items,OnItemClickListener mItemClickListener) {
        this.items = items;
        ctx = context;
        this.mOnItemClickListener = mItemClickListener;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        personActionList = appDatabases.personActionDAO().getAll();
    ...
    public void onBindViewHolder(@NonNull @NotNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof OriginalViewHolder) {
            ...
            //view.desc.setText(String.valueOf(personActionList.get(p.getGender().intValue()-1).getValue()));
