...
public class ListBasic extends AppCompatActivity {
    ...
    private void initComponent() {
        ...
        List<object> items = AppConfig.getobjectData(this);
        items.addAll(AppConfig.getobjectData(this));
        items.addAll(AppConfig.getobjectData(this));
       ...
       // mAdapter = new AdapterListBasic(this, items);
        ...
        mAdapter.setOnItemClickListener(new AdapterListBasic.OnItemClickListener() {
         ...
         //       Snackbar.make(parent_view, "Item " + obj.getValue() + " clicked", Snackbar.LENGTH_SHORT).show();
            }
        });
