package com.ditros.mcd.palette;
    ...
    public boolean handleMessage(Message msg) {
        switch (msg.what){
            case MSG_SAVE_FAILED:
                ...
                Toast.makeText(this,"Échec de la sauvegarde",Toast.LENGTH_SHORT).show();
                break;
            case MSG_SAVE_SUCCESS:
                mSaveProgressDlg.dismiss();
                Toast.makeText(this,"La planche à dessin a été sauvegardée",Toast.LENGTH_SHORT).show();
                break;
        }
        return true;
    }
